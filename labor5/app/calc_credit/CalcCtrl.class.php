...
require_once $conf->root_path.'/app/calc_credit/CalcForm.class.php';
require_once $conf->root_path.'/app/calc_credit/CalcResult.class.php';
...
class CalcCtrl{
    ...
    public function generateView(){
        ...
        $smarty->assign('page_title','Labor5');
        ...
        $smarty->display($conf->root_path.'/app/calc_credit/CalcCredit.tlp');
    }
